...
const MovieCard = ({ image, title,backdrop_path, description, id, media_type }) => {
  ...
  return (
    <>
      ...
      <div
        ...
        className="relative group overflow-hidden rounded-xl cursor-pointer bg-black/20 backdrop-blur-md w-full h-auto shadow-lg transition-transform duration-300 hover:scale-105 card"
      >
        <img
          src={image}
          alt={title}
